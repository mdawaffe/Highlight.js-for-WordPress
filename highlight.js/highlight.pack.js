  ...
  function highlight(language_name, value, ignore_illegals) {
    ...
    function startNewMode(mode, lexem) {
      ...
      if (mode.returnBegin) {
        ...
        if ( mode.excludeBeginClassName ) {
          result += '<span class="' + mode.excludeBeginClassName + '">' + escape(lexem) + '</span>' + markup;
        } else {
  ...
  return {
    ...
    contains: [
      ...
      },
      {
        subLanguage: 'xml',
        begin: '\\?>', end: '<\\?php',
        excludeBegin: true, returnEnd: true,
        excludeBeginClassName: 'preprocessor'
      },
      {
